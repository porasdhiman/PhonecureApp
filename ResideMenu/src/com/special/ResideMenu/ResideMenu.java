...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            Log.e("profile image","http://ec2-52-15-185-48.us-east-2.compute.amazonaws.com/uploads/users/" + image);
            if (image.contains("storage")) {
                ...
                Picasso.with(context).load("http://ec2-52-15-185-48.us-east-2.compute.amazonaws.com/uploads/users/" + image).placeholder(drawable).transform(new CircleTransform()).into(user_img);
