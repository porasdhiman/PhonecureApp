...
public class ResideMenu extends FrameLayout {
    ...
    private void initViews(Context context, int customLeftMenuId,
        ...
        if (customLeftMenuId >= 0) {
            ...
            Log.e("profile image","http://m.phonecure.eu/uploads/users/" + image);
            if (image.contains("storage")) {
                ...
                Picasso.with(context).load("http://m.phonecure.eu/uploads/users/" + image).placeholder(drawable).transform(new CircleTransform()).into(user_img);
